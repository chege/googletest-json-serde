...
pub mod json {
    ...
    pub use super::matchers::{
        ...
        is_integer, is_not_null, is_null, is_number, is_object, is_string, is_true, len,
...
pub use json::{
    ...
    is_not_null, is_null, is_number, is_object, is_string, is_true, len, matches_pattern, optional,
